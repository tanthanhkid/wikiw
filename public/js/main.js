...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.location.pathname.includes('/tu-khainiem/')) {
        return; // Exit early, no popups on tu-khainiem pages
    }
    
    // Mobile menu toggle - Only on bai-hoc pages
    ...
    // Copy code blocks - Only on bai-hoc pages
    if (window.location.pathname.includes('/bai-hoc/')) {
...
// Search functions - Only on bai-hoc pages
...
// Utility functions - Only on bai-hoc pages
...
if (window.location.pathname.includes('/bai-hoc/') && !window.location.pathname.includes('/tu-khainiem/')) {
