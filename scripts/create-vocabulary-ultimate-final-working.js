// Ultimate final working script to create vocabulary - can be called from JavaScript
const fs = require('fs');
...
if (args.length < 2) {
    console.error('Usage: node create-vocabulary-ultimate-final-working.js "Title" "Content" [tags] [categories]');
    process.exit(1);
}
