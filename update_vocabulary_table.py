...
# -*- coding: utf-8 -*-
"""
Script để tự động cập nhật bảng từ vựng - khái niệm
...
def update_vocabulary_table():
    ...
    print(f"Đang kiểm tra file: {index_file}")
    print(f"File tồn tại: {index_file.exists()}")
    ...
    for match in matches:
        ...
        if markdown_file.exists():
            ...
            if concept_text:
                ...
                print(f"Không tìm thấy khái niệm cho: {title}")
        else:
    ...
    print("Hoàn thành cập nhật bảng từ vựng!")
